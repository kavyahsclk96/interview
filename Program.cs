...
namespace DrawBoxesInConsoleWindow
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Draw.RectangleFromCursor(2, 2, 1, 0);
            ...
            Draw.RectangleFromCursor(2, 2, 1, 3, keepOriginalCursorLocation: true, color: ConsoleColor.Red);
            Console.WriteLine(" <--Cursor after test 3 was here.");

            // Test 4: draw a green 2 x 2 square below
            Draw.Rectangle(2, 2, 4, 2, Draw.DrawKind.BelowCursorButKeepCursorLocation, color: ConsoleColor.Green);
            Console.WriteLine(" <--Cursor after test 4 was here.");

            // Test 5: draw a cyan rectangle around everything
            Draw.RectangleFromTop(33, 15, 0, 0, ConsoleColor.Cyan, useDoubleLines: true);
    ...
    public static class Draw
    {
        ...
        /// <param name="keepOriginalCursorLocation">If true, the cursor will return back to the starting location.</param>
